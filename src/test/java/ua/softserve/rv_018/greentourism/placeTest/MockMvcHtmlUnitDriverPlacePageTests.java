...
/**
 * An end to end test that validates the {@link CreateMessagePage}. A few things
 * to notice:
 *
 * <ul>
 * <li>You will see that all the tests are the same as
 * {@link WebDriverCreateMessageITests}. This shows how little difference there
 * is in how you would write the tests.</li>
 * <li>The only difference is how we initialize our {@link WebDriver}</li>
 * <li>We do not need to run the web application on a server for this test since
 * we are using
