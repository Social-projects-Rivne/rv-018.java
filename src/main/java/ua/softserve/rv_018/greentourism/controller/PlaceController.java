...
import ua.softserve.rv_018.greentourism.model.*;
...
public class PlaceController {
	 ...
	 */
	@RequestMapping(value = "/places_coordinates", method = RequestMethod.GET, headers = "Accept=application/json", produces = {
			"application/json" })
	...
	public ResponseEntity<?> createPlace(@RequestHeader("Authorization") String authorization,
	 ...
	 *
	 * @param id
	 *            A Long URL path variable containing the Place primary key
	 *            identifier.
	 * @return A ResponseEntity containing a single Place object, if found, and
	 *         a HTTP status code as described in the method comment.
	 */
	@RequestMapping(value = "/{id}", method = RequestMethod.GET, headers = "Accept=application/json", produces = {
			"application/json" })
	 ...
	 *
	 * @param place
	 *            The Place object to be updated.
