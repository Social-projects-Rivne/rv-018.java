angular.module('greenApp')
	.controller('calendarCtrl', function($rootScope ,$scope, $filter, $http, $q, $log, CalendarIsOpen, CalendarDateRangeIsChosen, MapMarkersArray) {
    ...
    $scope.dayClick = function(date) {
    	if ($scope.selectedDate.length == 2) {
    		...
    		CalendarDateRangeIsChosen.setCalendarDateRangeIsChosen(true);
